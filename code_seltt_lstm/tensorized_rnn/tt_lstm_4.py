...
from .lstm_4 import LSTMCell, LSTM
...
class TTLSTMCell(LSTMCell):
    ...
    def __init__(self, input_size, hidden_size, bias, device,           # 이거는 init에서 정의 안하고 아래 각 함수에서 정의하는걸로
        ...
        print("@@@ (1) <START> TTLSTM Cell <def _init__>")
        ...
        print("@@@ (1)<END> TTLSTM Cell <def __init__>")

    def _create_input_hidden_weights(self):
        print("@@@ (2) <START> TTLSTM Cell <def _create_input_hidden_weight>")
    ...
    def _create_hidden_hidden_weights(self):
        print("@@@ (3) <START> TTLSTM Cell <def _create_hidden_hidden_weight>")
...
class TTLSTM(LSTM):
    ...
    def __init__(self, input_size, hidden_size, num_layers, num_flayers, device, n_cores,
        ...
        print("<START> TTLSTM <def __init__>")
    ...
    def _create_first_layer_cell(self):
        print("<START> TTLSTM <def _create_first_layer_cell>")
        print(" RETRUN> TTLSTMCell(I-H)")
    ...
    def _create_other_layer_cell(self):
        print("<START>  TTLSTM  <def _create_other_layer_cell")
        print(" RETRUN> TTLSTMCell(H-H)")
