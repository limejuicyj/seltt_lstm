...
def data_generator(root, batch_size):
    ...
    print( " len(train_set) : ", len(train_set))            # 50,000                    [ 50,000, ([1, 32, 32] , 7) ]
    print( " len(train_set[0]) : ", len(train_set[0]))      # 2
    print( " train_set[0][0].shape : ", train_set[0][0].shape)  # torch.Size([1, 32, 32])
    print( " train_set[0][1] : ", train_set[0][1])  # int / 7 /
