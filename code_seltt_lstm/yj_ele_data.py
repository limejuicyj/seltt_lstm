...
############## csv 파일 읽어서 6요소와 altitude만 추려서 npy로 저장 ##############
# 현재위치 확인
...
# 파일정보
INPUT_FOLDER = r'/home/youjin/research/seltt_lstm/code_seltt_lstm/data/space/altitude/'
# filename = 'K3A_EPH_ELE_altitude.csv'
# filename = 'K5_EPH_ELE_altitude.csv'
filename = 'K3_EPH_ELE_altitude.csv'
